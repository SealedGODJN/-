...
public class SynchronizedStaticAndNormal8 implements Runnable {
    private static SynchronizedStaticAndNormal8 instant = new SynchronizedStaticAndNormal8();
    ...
    private static synchronized void method1() {
        System.out.println("我是类lock的方法1，static。我叫" + Thread.currentThread().getName());
        try {
            Thread.sleep(3000);
